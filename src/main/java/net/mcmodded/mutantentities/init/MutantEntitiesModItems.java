...
public class MutantEntitiesModItems {
	...
	public static final RegistryObject<Item> SOLID_CHEMICAL_X = block(MutantEntitiesModBlocks.SOLID_CHEMICAL_X, MutantEntitiesModTabs.TAB_MUTANT_ENTITIES_BLOCKS);
	public static final RegistryObject<Item> TOXIC_DIRT = block(MutantEntitiesModBlocks.TOXIC_DIRT, MutantEntitiesModTabs.TAB_MUTANT_ENTITIES_BLOCKS);
	public static final RegistryObject<Item> WASTELAND_DIRT = block(MutantEntitiesModBlocks.WASTELAND_DIRT, MutantEntitiesModTabs.TAB_MUTANT_ENTITIES_BLOCKS);
	public static final RegistryObject<Item> DEAD_GRASS = block(MutantEntitiesModBlocks.DEAD_GRASS, MutantEntitiesModTabs.TAB_MUTANT_ENTITIES_BLOCKS);
	public static final RegistryObject<Item> MUTANT_ZOMBIE_SPAWN_EGG = REGISTRY.register("mutant_zombie_spawn_egg",
			() -> new ForgeSpawnEggItem(MutantEntitiesModEntities.MUTANT_ZOMBIE, -16732241, -8807323, new Item.Properties().tab(MutantEntitiesModTabs.TAB_MUTANT_ENTITIES_SPAWN_EGGS)));
	public static final RegistryObject<Item> MUTANT_HUSK_SPAWN_EGG = REGISTRY.register("mutant_husk_spawn_egg",
			() -> new ForgeSpawnEggItem(MutantEntitiesModEntities.MUTANT_HUSK, -8818591, -1651564, new Item.Properties().tab(MutantEntitiesModTabs.TAB_MUTANT_ENTITIES_SPAWN_EGGS)));
	public static final RegistryObject<Item> MUTANT_ZOMBIFIED_PIGLIN_SPAWN_EGG = REGISTRY.register("mutant_zombified_piglin_spawn_egg",
			() -> new ForgeSpawnEggItem(MutantEntitiesModEntities.MUTANT_ZOMBIFIED_PIGLIN, -1404013, -11767511, new Item.Properties().tab(MutantEntitiesModTabs.TAB_MUTANT_ENTITIES_SPAWN_EGGS)));
	public static final RegistryObject<Item> MUTANT_SKELETON_SPAWN_EGG = REGISTRY.register("mutant_skeleton_spawn_egg",
			() -> new ForgeSpawnEggItem(MutantEntitiesModEntities.MUTANT_SKELETON, -4079167, -11974327, new Item.Properties().tab(MutantEntitiesModTabs.TAB_MUTANT_ENTITIES_SPAWN_EGGS)));
	...
	public static final RegistryObject<Item> MUTANT_CREEPER_SPAWN_EGG = REGISTRY.register("mutant_creeper_spawn_egg",
			() -> new ForgeSpawnEggItem(MutantEntitiesModEntities.MUTANT_CREEPER, -15882485, -16121856, new Item.Properties().tab(MutantEntitiesModTabs.TAB_MUTANT_ENTITIES_SPAWN_EGGS)));
	public static final RegistryObject<Item> CREEPERLING_SPAWN_EGG = REGISTRY.register("creeperling_spawn_egg",
			() -> new ForgeSpawnEggItem(MutantEntitiesModEntities.CREEPERLING, -15882485, -16777216, new Item.Properties().tab(MutantEntitiesModTabs.TAB_MUTANT_ENTITIES_SPAWN_EGGS)));
	public static final RegistryObject<Item> MUTANT_IRON_GOLEM_SPAWN_EGG = REGISTRY.register("mutant_iron_golem_spawn_egg",
			() -> new ForgeSpawnEggItem(MutantEntitiesModEntities.MUTANT_IRON_GOLEM, -2372158, -9133262, new Item.Properties().tab(MutantEntitiesModTabs.TAB_MUTANT_ENTITIES_SPAWN_EGGS)));
	public static final RegistryObject<Item> CREEPER_BOMB = block(MutantEntitiesModBlocks.CREEPER_BOMB, MutantEntitiesModTabs.TAB_MUTANT_ENTITIES_BLOCKS);
	...
	public static final RegistryObject<Item> MUTANT_WITHER_SKELETON_SPAWN_EGG = REGISTRY.register("mutant_wither_skeleton_spawn_egg",
			() -> new ForgeSpawnEggItem(MutantEntitiesModEntities.MUTANT_WITHER_SKELETON, -15461356, -12104371, new Item.Properties().tab(MutantEntitiesModTabs.TAB_MUTANT_ENTITIES_SPAWN_EGGS)));
	...
	public static final RegistryObject<Item> MUTANT_DROWNED_SPAWN_EGG = REGISTRY.register("mutant_drowned_spawn_egg",
			() -> new ForgeSpawnEggItem(MutantEntitiesModEntities.MUTANT_DROWNED, -7343657, -8807323, new Item.Properties().tab(MutantEntitiesModTabs.TAB_MUTANT_ENTITIES_SPAWN_EGGS)));
	public static final RegistryObject<Item> THORNY_MUTANT_HUSK_SPAWN_EGG = REGISTRY.register("thorny_mutant_husk_spawn_egg",
			() -> new ForgeSpawnEggItem(MutantEntitiesModEntities.THORNY_MUTANT_HUSK, -8818591, -1651564, new Item.Properties().tab(MutantEntitiesModTabs.TAB_MUTANT_ENTITIES_SPAWN_EGGS)));
	public static final RegistryObject<Item> LORE_PAPER = REGISTRY.register("lore_paper", () -> new LorePaperItem());
	public static final RegistryObject<Item> MUTANT_ENDERMAN_SPAWN_EGG = REGISTRY.register("mutant_enderman_spawn_egg",
			() -> new ForgeSpawnEggItem(MutantEntitiesModEntities.MUTANT_ENDERMAN, -15329770, -16777216, new Item.Properties().tab(MutantEntitiesModTabs.TAB_MUTANT_ENTITIES_SPAWN_EGGS)));
	public static final RegistryObject<Item> NUCLEAR_SCIENCETABLE = block(MutantEntitiesModBlocks.NUCLEAR_SCIENCETABLE, MutantEntitiesModTabs.TAB_MUTANT_ENTITIES_BLOCKS);
	public static final RegistryObject<Item> CHEMICAL_X_ITEM = REGISTRY.register("chemical_x_item", () -> new ChemicalXItemItem());
	public static final RegistryObject<Item> ENDERSOUL_SPAWN_EGG = REGISTRY.register("endersoul_spawn_egg",
			() -> new ForgeSpawnEggItem(MutantEntitiesModEntities.ENDERSOUL, -10992800, -12241588, new Item.Properties().tab(MutantEntitiesModTabs.TAB_MUTANT_ENTITIES_SPAWN_EGGS)));
	...
	public static final RegistryObject<Item> SPIDER_PIG_SPAWN_EGG = REGISTRY.register("spider_pig_spawn_egg",
			() -> new ForgeSpawnEggItem(MutantEntitiesModEntities.SPIDER_PIG, -13357785, -1006174, new Item.Properties().tab(MutantEntitiesModTabs.TAB_MUTANT_ENTITIES_SPAWN_EGGS)));
	public static final RegistryObject<Item> MUTANT_SHULKER_SPAWN_EGG = REGISTRY.register("mutant_shulker_spawn_egg",
			() -> new ForgeSpawnEggItem(MutantEntitiesModEntities.MUTANT_SHULKER, -7051372, -11716526, new Item.Properties().tab(MutantEntitiesModTabs.TAB_MUTANT_ENTITIES_SPAWN_EGGS)));
	public static final RegistryObject<Item> MUTANT_SNOW_GOLEM_SPAWN_EGG = REGISTRY.register("mutant_snow_golem_spawn_egg",
			() -> new ForgeSpawnEggItem(MutantEntitiesModEntities.MUTANT_SNOW_GOLEM, -2493710, -8280924, new Item.Properties().tab(MutantEntitiesModTabs.TAB_MUTANT_ENTITIES_SPAWN_EGGS)));
	...
	public static final RegistryObject<Item> ANCIENT_BUSH = block(MutantEntitiesModBlocks.ANCIENT_BUSH, MutantEntitiesModTabs.TAB_MUTANT_ENTITIES_BLOCKS);
