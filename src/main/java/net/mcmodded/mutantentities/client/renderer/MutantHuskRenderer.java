...
public class MutantHuskRenderer extends GeoEntityRenderer<MutantHuskEntity> {
	...
	@Override
	public RenderType getRenderType(MutantHuskEntity entity, float partialTicks, PoseStack stack, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
