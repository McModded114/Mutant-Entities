...
public class MutantCreeperRenderer extends GeoEntityRenderer<MutantCreeperEntity> {
	...
	@Override
	public RenderType getRenderType(MutantCreeperEntity entity, float partialTicks, PoseStack stack, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
