...
public class MutantZombifiedPiglinRenderer extends GeoEntityRenderer<MutantZombifiedPiglinEntity> {
	...
	@Override
	public RenderType getRenderType(MutantZombifiedPiglinEntity entity, float partialTicks, PoseStack stack, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
