...
public class ThornyMutantHuskRenderer extends GeoEntityRenderer<ThornyMutantHuskEntity> {
	...
	@Override
	public RenderType getRenderType(ThornyMutantHuskEntity animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	@Override
	public void preRender(PoseStack poseStack, ThornyMutantHuskEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red,
