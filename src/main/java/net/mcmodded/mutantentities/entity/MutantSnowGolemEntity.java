...
public class MutantSnowGolemEntity extends Monster implements RangedAttackMob, GeoEntity {
	...
	public MutantSnowGolemEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MutantEntitiesModEntities.MUTANT_SNOW_GOLEM.get(), world);
	}

	public MutantSnowGolemEntity(EntityType<MutantSnowGolemEntity> type, Level world) {
		super(type, world);
		xpReward = 50;
		setNoAi(false);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "mutant_snow_golem");
	}
	...
	public class RangedAttackGoal extends Goal {
		...
		public void stop() {
			...
			this.seeTime = 0;
			this.attackTime = -1;
			((MutantSnowGolemEntity) rangedAttackMob).entityData.set(SHOOT, false);
		}
		...
		public void tick() {
			...
			if (--this.attackTime == 0) {
				...
				((MutantSnowGolemEntity) rangedAttackMob).entityData.set(SHOOT, true);
	...
	public void performRangedAttack(LivingEntity target, float flval) {
		MutantSnowGolemEntityProjectile entityarrow = new MutantSnowGolemEntityProjectile(MutantEntitiesModEntities.MUTANT_SNOW_GOLEM_PROJECTILE.get(), this, this.level);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 40) {
			this.remove(MutantSnowGolemEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
