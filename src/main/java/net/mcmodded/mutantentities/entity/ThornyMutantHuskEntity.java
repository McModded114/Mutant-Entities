...
public class ThornyMutantHuskEntity extends Monster implements IAnimatable {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(ThornyMutantHuskEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(ThornyMutantHuskEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(ThornyMutantHuskEntity.class, EntityDataSerializers.STRING);
	...
	public ThornyMutantHuskEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MutantEntitiesModEntities.THORNY_MUTANT_HUSK.get(), world);
	}

	public ThornyMutantHuskEntity(EntityType<ThornyMutantHuskEntity> type, Level world) {
		super(type, world);
		xpReward = 70;
		setNoAi(false);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "mutant_husk_cactus");
	}
	...
	public boolean hurt(DamageSource source, float amount) {
		MutantHuskAbilityProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this, source.getEntity());
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		ThornyMutantHuskStatsProcedure.execute(this);
		return retval;
	}
	...
	public static void init() {
		SpawnPlacements.register(MutantEntitiesModEntities.THORNY_MUTANT_HUSK.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 90) {
			this.remove(ThornyMutantHuskEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
