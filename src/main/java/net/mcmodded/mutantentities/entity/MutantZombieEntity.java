...
public class MutantZombieEntity extends Monster implements IAnimatable {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(MutantZombieEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(MutantZombieEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(MutantZombieEntity.class, EntityDataSerializers.STRING);
	...
	public MutantZombieEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MutantEntitiesModEntities.MUTANT_ZOMBIE.get(), world);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "mutant_zombie");
	}
	...
	public static void init() {
		SpawnPlacements.register(MutantEntitiesModEntities.MUTANT_ZOMBIE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 90) {
			this.remove(MutantZombieEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
