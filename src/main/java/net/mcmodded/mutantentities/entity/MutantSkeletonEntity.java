...
public class MutantSkeletonEntity extends Monster implements GeoEntity {
	...
	public MutantSkeletonEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MutantEntitiesModEntities.MUTANT_SKELETON.get(), world);
	}
	...
	public MutantSkeletonEntity(EntityType<MutantSkeletonEntity> type, Level world) {
		...
		xpReward = 50;
		setNoAi(false);
		this.setItemSlot(EquipmentSlot.HEAD, new ItemStack(Items.BOW));
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "mutant_skeleton");
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, true) {
			...
			protected double getAttackReachSqr(LivingEntity entity) {
				return (this.mob.getBbWidth() * this.mob.getBbWidth() + entity.getBbWidth()) * 50;
			}
		});
		this.goalSelector.addGoal(2, new RandomStrollGoal(this, 1));
		this.goalSelector.addGoal(3, new AvoidEntityGoal<>(this, Wolf.class, (float) 6, 1, 1.2));
	...
	public static void init() {
		SpawnPlacements.register(MutantEntitiesModEntities.MUTANT_SKELETON.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
