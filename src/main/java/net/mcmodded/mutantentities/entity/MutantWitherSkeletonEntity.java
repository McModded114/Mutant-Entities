...
import net.mcmodded.mutantentities.procedures.MutantWitherSkeletonStatsProcedure;
...
public class MutantWitherSkeletonEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(MutantWitherSkeletonEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(MutantWitherSkeletonEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(MutantWitherSkeletonEntity.class, EntityDataSerializers.STRING);
	...
	public MutantWitherSkeletonEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MutantEntitiesModEntities.MUTANT_WITHER_SKELETON.get(), world);
	}

	public MutantWitherSkeletonEntity(EntityType<MutantWitherSkeletonEntity> type, Level world) {
		super(type, world);
		xpReward = 80;
		setNoAi(false);
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(MutantEntitiesModItems.MUTANT_WITHER_SKELETON_SWORD.get()));
		this.setItemSlot(EquipmentSlot.OFFHAND, new ItemStack(MutantEntitiesModItems.MUTANT_WITHER_SKELETON_SWORD.get()));
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "mutant_wither_skeleton");
	}
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		MutantWitherSkeletonStatsProcedure.execute(this);
		return retval;
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 60) {
			this.remove(MutantWitherSkeletonEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
