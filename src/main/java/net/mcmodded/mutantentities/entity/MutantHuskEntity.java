...
public class MutantHuskEntity extends Monster implements IAnimatable {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(MutantHuskEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(MutantHuskEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(MutantHuskEntity.class, EntityDataSerializers.STRING);
	...
	public MutantHuskEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MutantEntitiesModEntities.MUTANT_HUSK.get(), world);
	}

	public MutantHuskEntity(EntityType<MutantHuskEntity> type, Level world) {
		super(type, world);
		xpReward = 50;
		setNoAi(false);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "mutant_husk");
	}
	...
	public static void init() {
		SpawnPlacements.register(MutantEntitiesModEntities.MUTANT_HUSK.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 90) {
			this.remove(MutantHuskEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
