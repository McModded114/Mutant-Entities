...
public class MutantSnowGolemSnowProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if (world.getLevelData().getGameRules().getBoolean(GameRules.RULE_MOBGRIEFING) == true) {
			...
			}).replaceable(world, (world.getBlockState(BlockPos.containing(entity.getX(), entity.getY(), entity.getZ()))))) {
				world.setBlock(BlockPos.containing(entity.getX(), entity.getY(), entity.getZ()), Blocks.SNOW.defaultBlockState(), 3);
			}
			if ((new Object() {
				public boolean replaceable(LevelAccessor _world, BlockState _blockState) {
					Level _level = _world instanceof Level ? (Level) _world : null;
			...
			}).replaceable(world, (world.getBlockState(BlockPos.containing(entity.getX() + 1, entity.getY(), entity.getZ()))))) {
				world.setBlock(BlockPos.containing(entity.getX() + 1, entity.getY(), entity.getZ()), Blocks.SNOW.defaultBlockState(), 3);
			}
			if ((new Object() {
				public boolean replaceable(LevelAccessor _world, BlockState _blockState) {
					Level _level = _world instanceof Level ? (Level) _world : null;
			...
			}).replaceable(world, (world.getBlockState(BlockPos.containing(entity.getX(), entity.getY(), entity.getZ() + 1))))) {
				world.setBlock(BlockPos.containing(entity.getX(), entity.getY(), entity.getZ() + 1), Blocks.SNOW.defaultBlockState(), 3);
			}
			if ((new Object() {
				public boolean replaceable(LevelAccessor _world, BlockState _blockState) {
					Level _level = _world instanceof Level ? (Level) _world : null;
