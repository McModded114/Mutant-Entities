...
public class MutantDrownedStatsProcedure {
	public static void execute(Entity entity) {
		...
		((LivingEntity) entity).getAttribute(net.minecraft.world.entity.ai.attributes.Attributes.ATTACK_DAMAGE).setBaseValue((20 * (double) MutantEntitiesConfigFileConfiguration.DAMAGE.get()));
		...
		((LivingEntity) entity).getAttribute(ForgeMod.SWIM_SPEED.get()).setBaseValue((2.5 * (double) MutantEntitiesConfigFileConfiguration.SPEED.get()));
	}
}
