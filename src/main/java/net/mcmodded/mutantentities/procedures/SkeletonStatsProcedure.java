...
public class SkeletonStatsProcedure {
	public static void execute(Entity entity) {
		...
		((LivingEntity) entity).getAttribute(net.minecraft.world.entity.ai.attributes.Attributes.ATTACK_KNOCKBACK).setBaseValue((1.5 * (double) MutantEntitiesConfigFileConfiguration.KNOCKBACK.get()));
		((LivingEntity) entity).getAttribute(ForgeRegistries.ATTRIBUTES.getValue(new ResourceLocation("mcmoddeds_api:size"))).setBaseValue(1.25);
	}
}
