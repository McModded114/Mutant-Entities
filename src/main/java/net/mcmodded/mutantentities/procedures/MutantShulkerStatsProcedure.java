...
public class MutantShulkerStatsProcedure {
	public static void execute(Entity entity) {
		if (entity == null)
			return;
		((LivingEntity) entity).getAttribute(net.minecraft.world.entity.ai.attributes.Attributes.MAX_HEALTH).setBaseValue((360 * (double) MutantEntitiesConfigFileConfiguration.HEALTH.get()));
		...
		((LivingEntity) entity).getAttribute(net.minecraft.world.entity.ai.attributes.Attributes.KNOCKBACK_RESISTANCE).setBaseValue((0.7 * (double) MutantEntitiesConfigFileConfiguration.KBRESISTANCE.get()));
	}
}
