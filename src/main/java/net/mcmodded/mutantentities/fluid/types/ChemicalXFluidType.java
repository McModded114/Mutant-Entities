...
package net.mcmodded.mutantentities.fluid.types;
...
public class ChemicalXFluidType extends FluidType {
	public ChemicalXFluidType() {
		super(FluidType.Properties.create().fallDistanceModifier(0F).canExtinguish(true).supportsBoating(true).canHydrate(true).motionScale(-0.014D).lightLevel(10).viscosity(100).canConvertToSource(true)
